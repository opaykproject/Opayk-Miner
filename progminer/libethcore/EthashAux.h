...
{
public:
    static Result eval(int epoch, h256 const& _headerHash, uint32_t _nonce) noexcept;
    static Result eval(int epoch, int _block_number, h256 const& _headerHash, uint32_t _nonce) noexcept;
};
...
struct Solution
{
    uint32_t nonce;                                // Solution found nonce
